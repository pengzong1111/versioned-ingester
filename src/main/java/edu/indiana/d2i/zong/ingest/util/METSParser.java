...
//                                        log.warn("Null PageRecord retrieved for FILEID: " + fileIDAttrValue + " metsFile: " + metsFile.getPath());
    ...
    public static void main(String[] args) {
    	String volumeDir = "/home/zong/ht_text_sample/data0/b3605651";
    	File volumeMetsFile = new File(volumeDir, "b3605651.mets.xml");
    	
    	VolumeRecord record = Tools.getVolumeRecord("uc1.b3605651", volumeMetsFile);
    	List<String> names = new ArrayList<String>(record.getPageFilenameSet());
    	//name: UCAL_B3605651_00001412.txt, id: TXT00001412, order: 1412, sequence: 00001412, label: 1370
    	/*
name: UCAL_B3605651_00001416.txt, id: TXT00001416, order: 1416, sequence: 00001416, label: 1372 
name: UCAL_B3605651_00001417.txt, id: TXT00001417, order: 1417, sequence: 00001417, label: null 
name: UCAL_B3605651_00001418.txt, id: TXT00001418, order: 1418, sequence: 00001418, label: null 
name: UCAL_B3605651_00001419.txt, id: TXT00001419, order: 1419, sequence: 00001419, label: null 
name: UCAL_B3605651_00001420.txt, id: TXT00001420, order: 1420, sequence: 00001420, label: null 
name: UCAL_B3605651_00001421.txt, id: TXT00001421, order: 1421, sequence: 00001421, label: null 
name: UCAL_B3605651_00001422.txt, id: TXT00001422, order: 1422, sequence: 00001422, label: null 
    	 */
    	Collections.sort(names);
    	for(String name : names) {
    		
    		PageRecord page = record.getPageRecordByFilename(name);
    		System.out.printf("name: %s, id: %s, order: %d, sequence: %s, label: %s \n", name, page.getID(), page.getOrder(), page.getSequence(), page.getLabel());
    	}
    }
}
